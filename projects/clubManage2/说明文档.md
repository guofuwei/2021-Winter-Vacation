...
select depart_man.id as depart_man_id,depart_man.department,collage_man.id as collage_man_id,collage_man.collage from depart_man,collage_man where depart_man.id=collage_man.depart_id order by depart_man.id;
